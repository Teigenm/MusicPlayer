...
public class MyFavoriteActivity extends BaseActivity implements View.OnClickListener,RecyclerViewTouchListener.OnItemClickListener, RecyclerViewTouchListener.OnItemLongClickListener{

    private static final int MY_FAVORITE_LIST_ID = 2;
    ...
    private static MyFavoriteActivity sMyFavoriteActivity;
    private static Object mLock = new Object();
    public static int sInitListFlag = 0;

    public static MyFavoriteActivity getInstance() {
        synchronized (mLock) {
            return sMyFavoriteActivity;
        }
    }
    ...
    private void initView() {
        ...
        mCoordinatorLayout = findViewById(R.id.my_favorite_coordinator_layout);
        mCollapsingToolbarLayout = findViewById(R.id.my_favorite_collapsing_layout);
        mCollapsingToolbarLayout.setExpandedTitleColor(ResourcesCompat.getColor(getResources(), android.R.color.white, null));

        mAppBarLayout = findViewById(R.id.my_favorite_app_bar);
        ...
        mFab = findViewById(R.id.my_favorite_fab);
        mFab.setOnClickListener(MyFavoriteActivity.this);
        ...
        mRandomPlayLayout.setOnClickListener(MyFavoriteActivity.this);

        mToolbarTextView = findViewById(R.id.my_favorite_toolbar_text_view);
        ...
        mRecyclerView.addItemDecoration(new DividerItemDecoration(MyFavoriteActivity.this,DividerItemDecoration.VERTICAL));
        mList = new ArrayList<>();
    ...
    public void init() {
        if(mHandler == null) {
            mHandler = new MyHandler(MyFavoriteActivity.this);
    ...
    public void initDate() {
        mDisposable.add(Completable.fromAction(() -> {
            mList.clear();
            mList.addAll(mMusicDao.getMusicsByListId(2) );
        }).subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(() -> {
                    if(mIsPlayListId == MY_FAVORITE_LIST_ID) {
    ...
    public void onItemClick(View view, int position) {
        if(UserManager.getInstance().getIsPlayListId() != MY_FAVORITE_LIST_ID) {
    ...
    public void onItemLongClick(View view, int position) {
        SelectSongOperationPopup songOperationPopup = new SelectSongOperationPopup(this,2,mList.get(position) );
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            ...
            case R.id.menu_search:
                SearchMusicActivity.go(MyFavoriteActivity.this,mList,getResources().getString(R.string.text_my_favorite));
                break;
            default:break;
        }
    ...
    public void addToPlayList() {
        if(UserManager.getInstance().getIsPlayListId() != MY_FAVORITE_LIST_ID) {
            mIsPlayListId = MY_FAVORITE_LIST_ID;
    ...
    private Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if( sInitListFlag == 0 && mBinder.getPlayPosition() <= 2000 && mIsPlayListId == MY_FAVORITE_LIST_ID) {
                mAdapter.notifyDataSetChanged();
                sInitListFlag = 1;
            }
