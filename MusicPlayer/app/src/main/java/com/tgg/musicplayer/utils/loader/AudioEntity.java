...
public class AudioEntity implements Parcelable {
    ...
    public AudioEntity(Bundle bundle) {
        ...
        //mAlbumArtist = bundle.getString(MediaStore.AudioEntity.AudioColumns.ALBUM_ARTIST);
        mAlbumArtist = null;
    ...
    public String toString() {
        return "AudioEntity{" +
                ...
                ", mYear=" + mYear +
                ", mIsDrm=" + mIsDrm +
                ", mIsRingtone=" + mIsRingtone +
                ", mIsMusic=" + mIsMusic +
                ", mIsAlarm=" + mIsAlarm +
                ", mIsNotification=" + mIsNotification +
                ", mIsPodcast=" + mIsPodcast +
                '}';
    }
}
